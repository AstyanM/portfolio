...
Figure 1 - Rehabilitation Project Location

## 1. Site Analysis and Architectural Constraints

Site analysis revealed almost flat terrain, a lack of biodiversity, and the absence of water points. The presence of mature trees led us to preserve as many as possible to promote a natural and sustainable setting.

To meet residents' needs, we integrated cultural and friendly spaces as well as a freely accessible football field. A natural space was also planned to offer a place for relaxation.
...
The project proposes the construction of housing adapted to a sustainable environment and for short durations. We then chose to go with single-story housing blocks for several reasons including these:

-   Spacing between bars allows a view towards the water point and greenery
...
Homes follow a modular design that allows space optimization while remaining pleasing to the eye.
...
### b) Plans and Technical Diagrams

Buildings are designed according to current standards and integrate several elements:
...
## 3. Public and Cultural Spaces Design

In parallel with housing, our project plans the rehabilitation of public spaces to promote conviviality and social mixing. The layout relies on creating structures adapted to residents' needs, while valuing local initiatives.

### a) Cultural Hall

We integrated a **cultural hall with diverse functionality** to address several issues:
...
As for the convenience store, it also responds to a real existing demand:
