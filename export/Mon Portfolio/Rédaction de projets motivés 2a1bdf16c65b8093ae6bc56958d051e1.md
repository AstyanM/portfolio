...
![Figure 1 : Distribution du nombre de phrases par classes](R%C3%A9daction%20de%20projets%20motiv%C3%A9s/image.png)
...
![Figure 2 : Courbes d’entraînement Loss/Accuracy du jeu de données](R%C3%A9daction%20de%20projets%20motiv%C3%A9s/image%201.png)
...
![Figure 3 : Documentation des endpoints de l’API](R%C3%A9daction%20de%20projets%20motiv%C3%A9s/image%202.png)
...
![Figure 4 : Interface graphique de la page d’évaluation](R%C3%A9daction%20de%20projets%20motiv%C3%A9s/image%203.png)
...
![ Figure 3 : Infrastructure Railway](R%C3%A9daction%20de%20projets%20motiv%C3%A9s/image%204.png)
